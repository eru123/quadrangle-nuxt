...
.w {
    @apply w-full;
    .c {
        @apply w-full mx-auto flex flex-col justify-center items-start;
    }
    ...
    .b { // banner
        ...
        .gcw {
            @apply px-12 w-full;
            .gc {
                @apply w-full max-w-screen-md flex flex-row px-12 mx-auto rounded-3xl items-center justify-center py-4 mb-12 ;
